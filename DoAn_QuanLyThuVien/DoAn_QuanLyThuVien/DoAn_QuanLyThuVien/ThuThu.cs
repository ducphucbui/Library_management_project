...
namespace DoAn_QuanLyThuVien
{
    public partial class ThuThu : Form
    {
        ...
        private void btntimkiemm_Click(object sender, EventArgs e)
        {
            ...
            if (MaThuThu.Trim() == "")
            {
                MessageBox.Show("Vui lòng nhập mã thủ thư cần tìm kiếm ", "Thông báo ", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            string query = "select * from Thuthu where MaThuThu like '%" + MaThuThu + "%'";
